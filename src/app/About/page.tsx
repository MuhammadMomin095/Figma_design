...
const AboutPage = () => {
    return (
        <div>
          ...
          <div className="w-[1305px] h-[1802px]">
  ...
  <Link href="/">
    ...
    <p className="flex-grow-0 flex-shrink-0 text-sm text-left text-black">About</p>
  </div>
  <div className="flex flex-col justify-start items-start absolute left-[135px] top-[422px] gap-10">
    <p className="flex-grow-0 flex-shrink-0 text-[54px] font-semibold text-justify text-black">
      Our Story
    </p>
    <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 relative gap-6">
      <p className="flex-grow-0 flex-shrink-0 w-[525px] text-base text-left text-black">
      ...
      <p className="flex-grow-0 flex-shrink-0 w-[505px] text-base text-left text-black">
  ...
  <div
    className="w-[705px] h-[609px] absolute left-[735px] top-[285px] overflow-hidden rounded-tl rounded-bl bg-[#eb7ea8]"
  >
    <img
      src="images/n.png"
      className="w-[837px] h-[609px] absolute left-[-1px] top-[-1px] object-none"
    />
  </div>
...
<div className='group'>
  ...
  <div className="flex justify-start items-start absolute left-[135px] top-[1404px] gap-[30px]">
    <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 relative gap-8">
      <div
        className="flex-grow-0 flex-shrink-0 w-[370px] h-[430px] relative overflow-hidden rounded bg-neutral-100"
      >
        <img
          src="images/o.png"
          className="w-[236px] h-[391px] absolute left-[66px] top-[38px] object-none"
        />
      </div>
      <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 gap-4">
        ...
        >
          <p className="flex-grow-0 flex-shrink-0 text-[32px] font-medium text-left text-black">
            Tom Cruise
          </p>
    ...
    <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 relative gap-8">
      ...
      >
        <img
          src="images/p.png"
          className="w-[294px] h-[397px] absolute left-[37px] top-8 object-none"
        />
      </div>
      <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 gap-4">
        <div
        ...
        >
          ...
          <p className="flex-grow-0 flex-shrink-0 text-base text-left text-black">Managing Director</p>
        </div>
        <div className="flex justify-start items-start flex-grow-0 flex-shrink-0 relative gap-4">
          <svg
            width="24"
    ...
    <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 relative gap-8">
      ...
      >
        <img
          src="images/q.png"
          className="w-[326px] h-[392px] absolute left-[21px] top-[37px] object-none"
        />
      </div>
      <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 gap-4">
        <div
        ...
        >
          ...
          <p className="flex-grow-0 flex-shrink-0 text-base text-left text-black">Product Designer</p>
        </div>
        <div className="flex justify-start items-start flex-grow-0 flex-shrink-0 relative gap-4">
          <svg
            width="24"
  ...
  <div className="flex justify-start items-center absolute left-[664px] top-[2008px] gap-3">
    <svg
      width="12"
      height="12"
      viewBox="0 0 12 12"
    ...
    >
      <circle opacity="0.3" cx="6" cy="6" r="6" fill="black"></circle></svg
    ><svg
      width="12"
      height="12"
      viewBox="0 0 12 12"
    ...
    ><svg
      ...
      preserveAspectRatio="none"
    >
      <circle cx="8" cy="8" r="5" fill="#DB4444"></circle>
      <circle opacity="0.3" cx="8" cy="8" r="7" stroke="black" strokeWidth="2"></circle></svg
    ><svg
      width="12"
      height="12"
      viewBox="0 0 12 12"
    ...
    ><svg
      ...
      preserveAspectRatio="xMidYMid meet"
    >
      <circle opacity="0.3" cx="6" cy="6" r="6" fill="black"></circle>
    </svg>
  </div>
</div>
      ...
      <div className="w-[1440px] h-[741px]">
  <div className="flex justify-center items-center absolute left-[248px] top-[2164px] gap-[88px]">
    <div className="flex flex-col justify-start transition-transform duration-700 ease-in-out hover:scale-105 items-center flex-grow-0 flex-shrink-0 relative gap-6">
      <svg
        width="81"
        height="80"
        viewBox="0 0 81 80"
      ...
      >
        ...
        ></path>
        <circle cx="40.5" cy="40" r="29" fill="black"></circle>
        <g clipPath="url(#clip0_40817_3513)">
          <path
    ...
    <div
      className="flex flex-col justify-start items-center transition-transform duration-700 ease-in-out hover:scale-105 flex-grow-0 flex-shrink-0 w-[262px] relative gap-6"
    >
      <svg
        width="80"
        height="80"
      ...
      >
        ...
        ></path>
        <circle cx="40" cy="40" r="29" fill="black"></circle>
        <g clipPath="url(#clip0_40817_3530)">
          <path
  ...
  <div className="w-[1440px] h-[440px] absolute left-0 top-[2465px] overflow-hidden bg-black">
    <div
