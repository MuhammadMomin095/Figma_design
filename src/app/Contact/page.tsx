...
const ContactPage = () => {
  ...
  >
    <div className="flex flex-col justify-start items-start absolute left-[35px] top-10 gap-8">
      <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 gap-6">
        <div className="flex justify-start items-center group flex-grow-0 flex-shrink-0 relative gap-4">
          <svg
            width="40"
            height="40"
            viewBox="0 0 40 40"
            ...
            preserveAspectRatio="none"
          >
            <rect className='opacity-80 group-hover:opacity-100' width="40" height="40" rx="20" fill="#DB4444"></rect>
            <path
      ...
      <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 gap-6">
        ...
        >
          ...
          <p className="flex-grow-0 flex-shrink-0 text-sm text-left text-black">
            Emails: mominshykh7@gmail.com
          </p>
          <p className="flex-grow-0 flex-shrink-0 text-sm text-left text-black">
            Emails: mominshykh8@gmail.com
          </p>
        </div>
      </div>
    </div>
  ...
  <div className="w-[1440px] h-[440px] absolute left-0 top-[920px] overflow-hidden bg-black">
