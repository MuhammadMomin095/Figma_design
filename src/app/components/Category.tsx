...
const Category : React.FC = () => {
  ...
  <div className="flex justify-start items-end flex-grow-0 flex-shrink-0 gap-[691px]">
    <div className="flex flex-col justify-start items-start left-[135px] flex-grow-0 flex-shrink-0 relative gap-5">
  ...
  <div className="flex justify-start items-start flex-grow-0 flex-shrink-0 relative gap-[30px]">
    <div
      className="flex-grow-0 flex-shrink-0 w-[170px] h-[145px] relative overflow-hidden rounded border border-black/30"
    >
      ...
      <svg
        ...
        preserveAspectRatio="none"
      >
        <g clipPath="url(#clip0_21815_847)">
          <path
    ...
    >
      ...
      <svg
        ...
        preserveAspectRatio="none"
      >
        <g clipPath="url(#clip0_21815_398)">
          <path
          ...
          <path
            ...
            strokeLinejoin="round"
          ></path>
          <path d="M8 32H48" stroke="black" strokeWidth="2" strokeLinecap="round"></path>
        </g>
        <defs>
          <clipPath id="clip0_21815_398">
            <rect width="56" height="56" fill="white"></rect>
          </clipPath>
        </defs>
      </svg>
    ...
    >
      ...
      <div className="w-14 h-14 absolute left-[57px] top-[25px] overflow-hidden">
        <div className="absolute left-[-1.42px] top-[-1.42px]"></div>
        <svg
          width="30"
          height="30"
          viewBox="0 0 30 30"
        ...
        <div
          className="flex justify-start items-end w-2.5 h-[13px] absolute left-[23px] top-[22px] gap-1"
        >
          <svg
            width="2"
            height="13"
    ...
    >
      <p className="absolute left-[51px] top-[97px] text-base text-left text-neutral-50">Camera</p>
      <svg
        width="56"
        height="56"
        viewBox="0 0 56 56"
        ...
        preserveAspectRatio="none"
      >
        <g clipPath="url(#clip0_21815_613)">
          <path
    ...
    >
      ...
      <svg
        ...
        preserveAspectRatio="none"
      >
        <g clipPath="url(#clip0_21815_623)">
          <path
    ...
    >
      ...
      <svg
        ...
        preserveAspectRatio="none"
      >
        <g clipPath="url(#clip0_21815_788)">
          <path
