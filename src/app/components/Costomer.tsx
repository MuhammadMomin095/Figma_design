  ...
  <div className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 relative gap-6">
    ...
    >
      <path
        ...
        fill="#2F2E30"
      ></path>
      <circle cx="40.5" cy="40" r="29" fill="black"></circle>
      <g clipPath="url(#clip0_21815_259)">
        <path
    ...
    <div className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 relative gap-2">
      ...
      <p className="flex-grow-0 flex-shrink-0 text-sm text-center text-black">
        Free delivery for all orders over $140
      </p>
    </div>
  </div>
  <div
    className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 w-[262px] relative gap-6"
  >
    <svg
      width="80"
      height="80"
    ...
    >
      <path
        ...
        fill="#2F2E30"
      ></path>
      <circle cx="40" cy="40" r="29" fill="black"></circle>
      <g clipPath="url(#clip0_21815_276)">
        <path
