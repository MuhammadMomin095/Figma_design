...
const Today: React.FC = () => {
  ...
  <div className="flex justify-start items-end flex-grow-0 flex-shrink-0 gap-[470px]">
    <div className="flex justify-start items-end left-[135px] flex-grow-0 flex-shrink-0 relative gap-[87px]">
      <div
      ...
      <div className="flex-grow-0 flex-shrink-0 w-[302px] h-[50px] relative">
        ...
        <div className="flex flex-col justify-start items-start absolute left-[63px] top-[26px] gap-2">
          <svg
            width="4"
            height="4"
            viewBox="0 0 4 4"
          ...
          >
            <circle cx="2" cy="2" r="2" fill="#E07575"></circle></svg        ><svg
            width="4"
            height="4"
            viewBox="0 0 4 4"
            fill="none"
        ...
        <div className="flex flex-col justify-start items-start absolute left-[143px] top-[26px] gap-2">
          <svg
            width="4"
            height="4"
            viewBox="0 0 4 4"
        ...
        <div className="flex flex-col justify-start items-start absolute left-[230px] top-[26px] gap-2">
          <svg
            width="4"
            height="4"
            viewBox="0 0 4 4"
  ...
  <div className="w-[1170px] h-[116px]">
  <svg
    width="1170"
    height="1"
    viewBox="0 0 1170 1"
    fill="none"
    xmlns="http://www.w3.org/2000/svg"
    className="absolute left-[1400.75px] top-[1334.75px] opacity-30"
    preserveAspectRatio="none"
  >
    <line opacity="0.3" x1="1170" y1="0.25" y2="0.25" stroke="black" strokeWidth="0.5"></line>
  </svg>
  <div
    className="mt-80 flex justify-center items-center absolute left-[603px] top-[1219px] gap-2.5 px-12 py-4 rounded bg-[#db4444]"
  >
    <Link href="/Wishlist">
