...
const Product: React.FC = () => {
  ...
  <div className="flex flex-col justify-start items-center flex-grow-0 flex-shrink-0 gap-[60px]">
    <div className="flex justify-start items-end flex-grow-0 flex-shrink-0 gap-[672px]">
      <div className="flex flex-col justify-start left-[77px] items-start flex-grow-0 flex-shrink-0 relative gap-5">
      ...
      <div className="flex justify-start items-start flex-grow-0 flex-shrink-0 gap-[30px]">
          ...
          >
            ...
            <div className="flex justify-start items-center flex-grow-0 flex-shrink-0 gap-2">
              ...
              <div className="flex justify-start items-start flex-grow-0 flex-shrink-0 relative gap-2">
                ...
                <p
                  className="flex-grow-0 flex-shrink-0 w-10 h-5 opacity-50 text-sm font-semibold text-left text-black"
                >
                  (325)
                </p>
              </div>
        ...
        >
          ...
          >
            ...
            <div className="w-[190px] h-[180px] absolute left-10 top-[35px] overflow-hidden"></div>
            <img
              src="images/d.png"
          ...
          >
            ...
            <div className="flex justify-start items-start flex-grow-0 flex-shrink-0 relative gap-2">
              <svg
                ...
                preserveAspectRatio="none"
              >
                <circle cx="10" cy="10" r="6" fill="#FB1314"></circle>
              ...
              >
                <circle cx="10" cy="10" r="10" fill="#DB4444"></circle>
              </svg>
            </div>
          </div>
        </div>
          ...
          >
            ...
            <div className="flex justify-start items-start flex-grow-0 flex-shrink-0 relative gap-2">
              <svg
                ...
                preserveAspectRatio="none"
              >
                <circle cx="10" cy="10" r="6" fill="#EEFF61"></circle>
                <circle cx="10" cy="10" r="9" stroke="black" strokeWidth="2"></circle></svg
              ><svg
                width="20"
                height="20"
          ...
          >
            ...
            <div className="flex justify-start items-start flex-grow-0 flex-shrink-0 relative gap-2">
              <svg
                ...
                preserveAspectRatio="none"
              >
                <circle cx="10" cy="10" r="6" fill="black"></circle>
                <circle cx="10" cy="10" r="9" stroke="black" strokeWidth="2"></circle></svg
              ><svg
                width="20"
                height="20"
          ...
          >
            ...
            <div className="flex justify-start items-start flex-grow-0 flex-shrink-0 relative gap-2">
              <svg
                ...
                preserveAspectRatio="none"
              >
                <circle cx="10" cy="10" r="6" fill="#184A48"></circle>
                <circle cx="10" cy="10" r="9" stroke="black" strokeWidth="2"></circle></svg
              ><svg
                width="20"
                height="20"
