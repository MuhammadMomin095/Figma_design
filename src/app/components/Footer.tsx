const Footer = () => {
    return (
      <div className="mt-48">
        ...
        <div className="w-[1440px] h-[440px] relative overflow-hidden bg-black">
  <div
  ...
  >
    ...
    >
      <g opacity="0.5"><line opacity="0.4" y1="0.5" x2="1440" y2="0.5" stroke="white"></line></g>
    </svg>
  ...
  <div className="flex justify-center items-start absolute left-[135px] top-20 gap-[87px]">
    <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 gap-4">
      ...
      <div
        className="flex justify-start items-center flex-grow-0 flex-shrink-0 w-[217px] relative gap-8 pl-4 py-3 rounded border-[1.5px] border-neutral-50"
      >
        <p className="flex-grow-0 flex-shrink-0 opacity-40 text-base text-left text-neutral-50">
          Enter your email
        </p>
        <svg
          width="24"
    ...
    <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 relative gap-6">
      <p className="flex-grow-0 flex-shrink-0 text-xl font-medium text-left text-neutral-50">Support</p>
    ...
    <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 relative gap-6">
      <p className="flex-grow-0 flex-shrink-0 text-xl font-medium text-left text-neutral-50">Account</p>
      <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 relative gap-4">
        <p className="flex-grow-0 flex-shrink-0 text-base text-left text-neutral-50">My Account</p>
        <p className="flex-grow-0 flex-shrink-0 text-base text-left text-neutral-50">
          Login / Register
        </p>
    ...
    <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 relative gap-6">
      ...
      <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 relative gap-4">
        <p className="flex-grow-0 flex-shrink-0 text-base text-left text-neutral-50">Privacy Policy</p>
        <p className="flex-grow-0 flex-shrink-0 text-base text-left text-neutral-50">Terms Of Use</p>
    ...
    <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 gap-6">
      <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 relative gap-6">
        ...
        >
          <p
            className="flex-grow-0 flex-shrink-0 opacity-70 text-xs font-medium text-left text-neutral-50"
          >
          ...
          <div className="flex justify-start items-center flex-grow-0 flex-shrink-0 relative gap-2">
            ...
            >
              <div
                className="flex-grow-0 flex-shrink-0 w-[110px] h-10 relative overflow-hidden bg-[#030406]"
              >
                <img
              ...
              <div
                className="flex-grow-0 flex-shrink-0 w-[110px] h-10 relative overflow-hidden bg-black"
              >
                <img
      ...
      <div className="flex justify-start items-start flex-grow-0 flex-shrink-0 relative gap-6">
        ...
        ><svg
          ...
          preserveAspectRatio="none"
        >
          <g clipPath="url(#clip0_21815_1538)">
            <path
