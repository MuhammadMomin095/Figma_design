...
const WishlistPage = () => {
    return (
        <div>
          ...
          <div className="w-[1170px] h-[984px]">
  <div className="flex flex-col justify-start items-start absolute left-[135px] top-[222px] gap-20">
      ...
      <div className="flex justify-start items-start flex-grow-0 flex-shrink-0 gap-[30px]">
        ...
        >
          ...
          >
            ...
            <div className="flex justify-start opacity-0 group-hover:opacity-100 items-center absolute left-[83.5px] top-[217px] gap-2">
              <svg
                width="25"
                height="24"
                viewBox="0 0 25 24"
              ...
              <Link href="/Cart">
              <p className="flex-grow-0 flex-shrink-0 opacity-0 group-hover:opacity-100 text-xs text-left text-white">Add To Cart</p>
              </Link>
            </div>
          </div>
          <div
        ...
        >
          ...
          >
            ...
            <div className="flex justify-start opacity-0 group-hover:opacity-100 items-center absolute left-[83.5px] top-[217px] gap-2">
              ...
              <Link href="/Cart">
              <p className="flex-grow-0 flex-shrink-0 text-xs opacity-0 group-hover:opacity-100 text-left text-white">Add To Cart</p>
              </Link>
            </div>
      ...
      <div className="flex justify-start items-start flex-grow-0 flex-shrink-0 gap-[30px]">
        ...
        >
          ...
          >
            ...
            <div className="flex justify-start items-center opacity-0 group-hover:opacity-100 absolute left-[85px] top-[218px] gap-2">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
        ...
        >
          ...
          >
            ...
            <div className="flex justify-start opacity-0 group-hover:opacity-100 items-center absolute left-[85px] top-[218px] gap-2">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
  ...
  <div className="w-[1440px] h-[440px] absolute left-0 top-[1346px] overflow-hidden bg-black">
